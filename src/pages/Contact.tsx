  ...
  return (
    <div className="min-h-full bg-cream">
      ...
      <div className="mx-auto max-w-3xl px-5 py-8">
        ...
        {/* Quick-help banner */}
        <div className="rounded-2xl bg-court-50 border border-court-100 p-4 mb-6 flex flex-col sm:flex-row items-start sm:items-center gap-3">
          <p className="text-[13px] text-ink-2 flex-1">
            Many questions are answered in our{' '}
            <Link to="/faq" className="text-court font-semibold mkt-link pb-0.5">FAQ</Link>{' '}
            and{' '}
            <Link to="/support" className="text-court font-semibold mkt-link pb-0.5">Help Centre</Link>.
          </p>
          <Link
            to="/faq"
            ...
            <div className="mkt-card-hover rounded-2xl bg-white border border-hairline shadow-sm p-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-ink-2">Wynaxa Sports Tech Ltd</p>
                  <p className="text-[12px] text-ink-2">(part of Wynaxa Limited)</p>
                  <div className="flex items-start gap-1.5 mt-2">
                    <MapPin className="h-3.5 w-3.5 text-ink-2 flex-shrink-0 mt-0.5" />
          ...
          <div className="mkt-card-hover rounded-2xl bg-white border border-hairline shadow-sm p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:support@padelplayersapp.com" className="text-[13px] text-court font-semibold mkt-link pb-0.5">
                  support@padelplayersapp.com
                </a>
                <p className="text-[12px] text-ink-2 mt-1">We respond within 1 business day.</p>
              </div>
            </div>
          </div>
          <div className="mkt-card-hover rounded-2xl bg-white border border-hairline shadow-sm p-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:privacy@padelplayersapp.com" className="text-[13px] text-court font-semibold mkt-link pb-0.5">
                  privacy@padelplayersapp.com
                </a>
                <p className="text-[12px] text-ink-2 mt-1">GDPR requests, data deletion, privacy questions.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl bg-alert-50 border border-alert/40 p-5 mb-8">
          ...
          <p className="text-[13px] text-ink-2 leading-relaxed">
            Email{' '}
            <a href="mailto:support@padelplayersapp.com" className="text-court mkt-link pb-0.5">
              support@padelplayersapp.com
            </a>{' '}
            with details, or{' '}
            <Link to="/faq#report-player" className="text-court mkt-link pb-0.5">
        ...
        <div className="pt-6 border-t border-hairline">
          <div className="flex flex-wrap gap-x-5 gap-y-2 text-[13px] font-medium text-ink-2">
            <Link to="/support" className="mkt-link pb-0.5 hover:text-court transition-colors">Help Centre</Link>
            <Link to="/faq" className="mkt-link pb-0.5 hover:text-court transition-colors">FAQ</Link>
