...
function getNavTarget(n: Notification): string | null {
  ...
  switch (n.type) {
    ...
    case 'connection_accepted':
      return '/discover/players#connections'
  ...
  if (n.type === 'ringer_offer' || n.type === 'ringer_approved' || n.type === 'ringer_declined') return `/discover/groups/${n.related_id}`
  ...
  if (n.type.includes('group'))  return `/discover/groups/${n.related_id}`
