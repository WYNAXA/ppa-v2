    ...
    <div className="rounded-2xl bg-white border border-hairline shadow-sm p-5 hover:border-court-100 hover:shadow-md transition-all">
      <div className="flex items-start gap-3 mb-3">
        ...
        <div>
          ...
          <p className="text-[12px] text-ink-2 mt-0.5">{desc}</p>
        </div>
      </div>
      <ul className="space-y-1.5 ml-[52px]">
        {links.map((l) => (
          <li key={l.href}>
            <Link
              to={l.href}
              className="group flex items-center gap-1 text-[13px] text-court font-medium hover:underline"
            >
              <span>{l.label}</span>
    ...
    <div className="min-h-full bg-cream">
      ...
      <div className="mx-auto max-w-3xl px-5 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-[14px] text-ink-2 max-w-md mx-auto">
            Browse topics below or{' '}
            <Link to="/faq" className="text-court font-semibold hover:underline">search the full FAQ</Link>.
          </p>
        </div>
        ...
        {/* Still need help? */}
        <div className="rounded-2xl bg-gradient-to-br from-court-50 to-white border border-court-100 p-6 text-center mb-8">
          <div className="mx-auto mb-3 h-12 w-12 rounded-xl bg-court flex items-center justify-center">
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            <Link
              to="/contact"
              className="inline-flex items-center gap-1.5 rounded-xl bg-court px-5 py-2.5 text-[13px] font-semibold text-white hover:bg-court transition-colors"
            >
              Contact Us
        ...
        <div className="rounded-2xl bg-red-50 border border-red-100 p-5 mb-8">
          ...
          <p className="text-[13px] text-ink-2 leading-relaxed">
            ...
            <a href="mailto:support@padelplayersapp.com" className="text-court underline hover:no-underline">support@padelplayersapp.com</a>{' '}
        ...
        <div className="pt-6 border-t border-hairline">
          ...
          <p className="mt-3 text-[12px] text-ink-3">Wynaxa Sports Tech Ltd (part of Wynaxa Limited) &middot; 26 Fitzwilliam Square West, Dublin, D02 HX82, Ireland</p>
        </div>
      </div>
    </div>
  )
