-- ════════════════════════════════════════════════════════════════════════════
-- Update confirm_poll_schedule to write window_start/window_end for range-poll
-- matches. Columns are nullable; legacy slot matches pass NULL.
--
...
-- 1. Updated confirm_poll_schedule — reads window_start/window_end from schedule JSON
